...
public class nsBIG5Verifier extends nsVerifier {
  ...
  public nsBIG5Verifier() {
    ...
    states[0] = ((((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError))) << 16)
        | (((((3) << 4) | (eStart)) << 8) | (((eStart) << 4) | (eError)));
    states[1] = ((((((eError) << 4) | (eItsMe)) << 8) | (((eItsMe) << 4) | (eItsMe))) << 16)
        | (((((eItsMe) << 4) | (eItsMe)) << 8) | (((eError) << 4) | (eError)));
    states[2] = ((((((eStart) << 4) | (eStart)) << 8) | (((eStart) << 4) | (eStart))) << 16)
