...
public class nsISO2022JPVerifier extends nsVerifier {
  ...
  public nsISO2022JPVerifier() {
    ...
    states[3] =
        ((((((4) << 4) | (eError)) << 8) | (((eError) << 4) | (eError))) << 16) | (((((5) << 4) | (eError)) << 8) | (((eError) << 4) | (eError)));
    states[4] = ((((((eError) << 4) | (eItsMe)) << 8) | (((eError) << 4) | (eItsMe))) << 16)
        | (((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError)));
    states[5] = ((((((eError) << 4) | (eError)) << 8) | (((eItsMe) << 4) | (eItsMe))) << 16)
        | (((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError)));
