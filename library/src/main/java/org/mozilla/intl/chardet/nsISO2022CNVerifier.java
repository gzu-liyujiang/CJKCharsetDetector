...
public class nsISO2022CNVerifier extends nsVerifier {
  ...
  public nsISO2022CNVerifier() {
    ...
    states[0] = ((((((eStart) << 4) | (eStart)) << 8) | (((eStart) << 4) | (eStart))) << 16)
        | (((((eStart) << 4) | (eError)) << 8) | (((3) << 4) | (eStart)));
    states[1] = ((((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError))) << 16)
        | (((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eStart)));
    states[2] = ((((((eItsMe) << 4) | (eItsMe)) << 8) | (((eItsMe) << 4) | (eItsMe))) << 16)
        | (((((eItsMe) << 4) | (eItsMe)) << 8) | (((eError) << 4) | (eError)));
    states[3] =
        ((((((eError) << 4) | (4)) << 8) | (((eError) << 4) | (eError))) << 16) | (((((eError) << 4) | (eItsMe)) << 8) | (((eItsMe) << 4) | (eItsMe)));
    states[4] = ((((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError))) << 16)
        | (((((eItsMe) << 4) | (eError)) << 8) | (((eError) << 4) | (eError)));
    states[5] = ((((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError))) << 16)
        | (((((eError) << 4) | (eError)) << 8) | (((6) << 4) | (5)));
    states[6] = ((((((eError) << 4) | (eError)) << 8) | (((eError) << 4) | (eError))) << 16)
        | (((((eItsMe) << 4) | (eError)) << 8) | (((eError) << 4) | (eError)));
    states[7] = ((((((eStart) << 4) | (eError)) << 8) | (((eItsMe) << 4) | (eError))) << 16)
